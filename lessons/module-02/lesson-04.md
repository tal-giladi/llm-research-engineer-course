...
<div class="prereq">
<p><strong>Prerequisites:</strong> <a href="#/lessons/module-02/lesson-03">02.3 · Backprop through linear + softmax + cross-entropy by hand</a> — the VJP of a concrete op and the fan-in summation of gradients. <a href="#/lessons/module-02/lesson-02">02.2</a>'s computational-graph picture (nodes = ops, edges = tensors) is used throughout. A first acquaintance with <a href="#/lessons/module-00/lesson-03">00.3 · Autograd: backward and grad</a> helps.</p>
...
Continue to [03.1 · Gradient descent, SGD, momentum](lessons/module-03/lesson-01.md). See also the [curriculum map](curriculum/course-outline.md) for how the gradient machinery feeds the optimization and Transformer modules.
