...
<div class="prereq">
<p><strong>Prerequisites:</strong> the memory hierarchy and HBM-as-bottleneck from <a href="lesson-01.md">08.1</a>; arithmetic intensity, the roofline, and "memory-bound vs compute-bound" from <a href="lesson-02.md">08.2</a>; the four memory buckets (params, grads, optimizer state, activations) from <a href="../module-07/lesson-04.md">07.4</a>; floating-point basics from <a href="../module-01/lesson-01.md">Module 1</a>.</p>
...
Continue to [08.4 · FlashAttention & a Triton kernel; benchmark](lesson-04.md).
