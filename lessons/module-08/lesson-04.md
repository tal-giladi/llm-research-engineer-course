...
<div class="prereq">
<p><strong>Prerequisites:</strong> scaled dot-product attention and the $T\times T$ score matrix from <a href="#/lessons/module-05/lesson-02">05.2 · Q/K/V & scaled dot-product attention</a> (the exact formula $\mathrm{softmax}(QK^\top/\sqrt{d}+M)V$); arithmetic intensity, the roofline, and kernel fusion from <a href="#/lessons/module-08/lesson-02">08.2</a>; the SRAM-vs-HBM memory hierarchy from <a href="#/lessons/module-08/lesson-01">08.1</a>; softmax numerical stability (the max-subtraction trick) from the probability module.</p>
...
Recall exact attention from [05.2](lessons/module-05/lesson-02.md), for one head, query/key/value matrices of shape $(T, d)$:
...
Continue to [09.1 · Data parallelism, all-reduce, DDP](lessons/module-09/lesson-01.md), and read [FlashAttention (paper #7)](papers/index.md) now that you have implemented its algorithm.
